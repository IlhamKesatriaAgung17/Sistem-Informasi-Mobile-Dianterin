            ...
            <div class="col-md-6">
                ...
                @if (Route::has('login'))
                    @auth
                        ...
                        @endif
                        @else
                        <p class="fs-16 wow fadeInUp" data-wow-offset="50" data-wow-delay=".25s">Silahkan Login terlebih dahulu untuk mengecek ongkos kirim berdasarkan tempat yang ingin dituju</p>
                        <div class="calculate-form">
                            <form class="row" action="{{route('cek-ongkir')}}" method="GET">
                                @csrf
                                {{-- <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                                ...
                                <div class="form-group wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                                    <div class="col-sm-9 col-xs-12 pull-right">
                                        <a href="{{route('login')}}" class="btn btn-1 btn-block" style="text-align: center"><span> Cek Ongkir</span></a>
                                    </div>
                                </div>
                            </form>
                            @if ($cekongkir)
