        ...
        <div class="theme-container container">
            <div class="row">
                <div class="col-md-3 col-sm-6 footer-widget">
                    <a href="#"> <img class="logo" alt="#" src="{{asset('assets/img/logo/rsz_logo5.png')}}" />  </a>
                </div>
                <div class="col-md-3 col-sm-6 footer-widget">
                    <h2 class="title-1 fw-900">Menu Website</h2>
                    <ul>
                ...
                <div class="col-md-3 col-sm-6 footer-widget">
                    <h2 class="title-1 fw-900">Media Sosial Kami</h2>
        ...
        <div class="theme-container container">
            <div class="row">
                ...
                <div class="col-md-6 col-sm-6 text-right">
                    <p> Design and <span class="theme-clr fa fa-heart"></span>  by <a href="#" class="main-clr"> Dianterin </a> </p>
                </div>
            </div>
        </div>
    </div>
